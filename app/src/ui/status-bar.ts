...
const STATE_CONFIG: Record<ProthState, { text: string; icon: string; tooltip: string }> = {
  ...
  [ProthState.IDLE]: { text: 'Prother', icon: 'mic', tooltip: 'Press Ctrl+Shift+V to start speaking' },
  [ProthState.LISTENING]: { text: 'Listening...', icon: 'pulse', tooltip: 'Speaking... press Ctrl+Shift+V to stop' },
